...
subtitle: "An investigation of the artistic ideal versus a representative populations sample "
author: 
- name: "Jessica Smith"
...
keywords: |
    Loomis, Correlation
abstract: |
  In this article we compare the ideal body proportions characteized by Andrew Loomis \citep{Loomis:1943} to a sample of 105 adults collected by WSU sudents.
...
Andrew Lewis was a well known and influential art instructor in the mid 20th century. He authored a series of art manuals describing in detail how to draw the human body that are still being published today over 80 years later \citep{harris2000andrew}. In his iconic work "Figure Drawing For All It's Worth", he describes the artistic ideal male and female proportions (fig__).    
